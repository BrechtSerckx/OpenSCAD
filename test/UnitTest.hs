    ...
    [ testGroup
        ...
        [ testGroup
          ...
          testGroup
            ...
            [ st "1" "cylinder(r1=1.0,h=2.0,r2=2.0);" $ obCylinder 1 2 2 def,
              st
                "2"
                "cylinder(r1=1.0,h=2.0,r2=2.0,$fs=0.6);"
              ...
              st
                "4"
                "cylinder(r1=1.0,h=2.0,r2=2.0,$fa=30.0);"
      ...
      testGroup
        ...
        [ testGroup
            ...
            [ st
                "scale 1"
                "scale([0.5,1.0,2.0])cube([1.0,1.0,1.0]);"
                (scale (0.5, 1, 2) $ cube 1),
              st
                "scale 2"
                "scale([0.5,2.0])square([1.0,1.0]);"
                (scale (0.5, 2) $ rectangle 1 1),
              st
                "resize 1"
                "resize([10.0,20.0])square([2.0,2.0]);"
                (resize (10, 20) $ square 2),
              st
                "resize 2"
                "resize([10.0,20.0,30.0])cube([2.0,2.0,2.0]);"
          ...
          testGroup
            ...
            [ st
                "1"
                "mirror([1.0,0.0,0.0])cube([2.0,2.0,2.0]);"
                (mirror (1, 0, 0) $ cube 2),
              st
                "2"
                "mirror([0.0,1.0,0.0])cube([2.0,2.0,2.0]);"
                (mirror (0, 1, 0) $ cube 2),
              st
                "3"
          ...
          testGroup
            ...
            [ st "color 1" "color([1.0,0.0,0.0])cube([1.0,1.0,1.0]);" (color red $ cube 1),
              st
                "color 2"
                "color([1.0,0.0,0.0])square([1.0,1.0]);"
                (color red $ square 1),
              st
                "transparent 1"
                "color([1.0,0.0,0.0,0.7])cube([1.0,1.0,1.0]);"
                (transparent (red `withOpacity` 0.7) $ cube 1),
              st
                "transparent 2"
                "color([1.0,0.0,0.0,0.7])square([1.0,1.0]);"
      ...
      testGroup
        ...
        [ st
            "union"
            "union(){cube([1.0,1.0,1.0]);sphere(1.1,$fs=0.1);}"
            (union [cube 1, sphere 1.1 $ fs 0.1]),
          st
            "difference"
            "difference(){cube([1.0,1.0,1.0]);sphere(1.1,$fs=0.1);}"
            (difference (cube 1) . sphere 1.1 $ fs 0.1),
          st
            "intersection"
            "intersection(){cube([1.0,1.0,1.0]);sphere(1.1,$fs=0.1);}"
          ...
          st
            "hull"
            "hull(){translate([15.0,10.0])circle(10.0);circle(10.0);}"
      ...
      testGroup
        ...
        [ st
            "# 3d"
            "translate([-3.0,-3.0,-3.0])color([1.0,0.0,0.0])cube([3.0,3.0,3.0]);"
          ...
          st
            "Monoid 1 2d"
            "union(){square([1.0,1.0]);circle(1.1,$fs=0.1);}"
